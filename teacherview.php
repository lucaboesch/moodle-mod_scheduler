...
$inactive = [];
if ($DB->count_records('scheduler_slots', ['schedulerid' => $scheduler->id]) <= $DB->count_records('scheduler_slots',
        ['schedulerid' => $scheduler->id, 'teacherid' => $USER->id]) ) {
...
$addbuttons = [];
$addbuttons[] = $commandbar->action_link(new moodle_url($actionurl, ['what' => 'addsession']), 'addsession', 't/add');
$addbuttons[] = $commandbar->action_link(new moodle_url($actionurl, ['what' => 'addslot']), 'addsingleslot', 't/add');
